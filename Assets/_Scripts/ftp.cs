...
public class ftp {
    public static readonly string sucessMessage = "success";
    public static readonly string failMessage = "fail";
    ...
    public IEnumerator downloadAsync (string remoteFile, string localFile) {
        bool failed = false;
    ...
    public IEnumerator uploadAsync (string remoteFile, string localFile) {
        bool failed = false;
